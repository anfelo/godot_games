...
# ANCHOR: apply_base_movement
# ANCHOR: base_velocity
...
func apply_base_movement(delta: float) -> void:
	...
	# END: move_character
# END: apply_base_movement

# ANCHOR: bool_functions
